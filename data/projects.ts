        ...
        walkthrough: [
          {
            ...
            image: "/images/video-transcription/01-choose-file.png",
            imageAlt: "Video Transcription choose file screenshot.",
          },
          {
            number: "02",
            title: "Start the script",
            description: "Run the Python command and enter the file path.",
            image: "/images/video-transcription/02-start-script.png",
            imageAlt: "Video Transcription start script screenshot.",
          },
          {
            number: "03",
            title: "Process the recording",
            description: "Faster-Whisper handles the transcription locally.",
            image: "/images/video-transcription/03-process-recording.png",
            imageAlt: "Video Transcription process recording screenshot.",
          },
          {
            number: "04",
            title: "Create the transcript",
            description: "The workflow produces timestamped text from the recording.",
            image: "/images/video-transcription/04-create-transcript.png",
            imageAlt: "Video Transcription create transcript screenshot.",
          },
          {
            number: "05",
            title: "Save automatically",
            description: "The transcript is named and saved in the chosen output folder.",
            image: "/images/video-transcription/05-save-automatically.png",
            imageAlt: "Video Transcription save automatically screenshot.",
          },
          {
            number: "06",
            ...
            image: "/images/video-transcription/06-review-result.png",
            imageAlt: "Video Transcription review result screenshot.",
          },
        ],
      },
    ],
